...
namespace ProyectoIker.Backend.Servicios
{
    public class EmpleadoRepository : GenericRepository<Empleado>
    {
        ...
        /// <summary>
        /// Crea una nueva instancia de <see cref="EmpleadoRepository"/>.
        /// </summary>
        ...
        public async Task<Empleado?> GetByUsernameAsync(string username, CancellationToken cancellationToken = default)
        {
            return await Query(asNoTracking: true)
                         .FirstOrDefaultAsync(u => u.Usuario == username, cancellationToken)
                         .ConfigureAwait(false);
        }
        ...
        {
            return await Query(asNoTracking: true)
                         .AnyAsync(u => u.Usuario == username, cancellationToken)
                         .ConfigureAwait(false);
        }
